#!/usr/bin/env python3
"""
Ejecutar solo la generación de documentación con OpenAI
...
from transcribir import generar_documentacion_con_openai
...
def main():
    ...
    resultado = generar_documentacion_con_openai(transcripciones_file)
    
    if resultado:
        print(f"✅ Documentación generada exitosamente")
        print(f"📂 Revisa la carpeta: www/openai/")
    else:
